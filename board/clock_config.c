...
outputs:
- {id: Bus_clock.outFreq, value: 21 MHz, locked: true, accuracy: '0.001'}
- {id: Core_clock.outFreq, value: 84 MHz}
- {id: Flash_clock.outFreq, value: 21 MHz}
- {id: LPO_clock.outFreq, value: 1 kHz}
- {id: System_clock.outFreq, value: 84 MHz, locked: true, accuracy: '0.001'}
settings:
...
- {id: SIM.OUTDIV2.scale, value: '8', locked: true}
...
const sim_clock_config_t simConfig_BOARD_BootClockRUN =
    {
        ...
        .clkdiv1 = 0x17070000U,                   /* SIM_CLKDIV1 - OUTDIV1: /2, OUTDIV2: /8, OUTDIV4: /8 */
    };
